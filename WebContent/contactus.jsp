              ...
              <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                <div class="card border-0">
                   <div class="card-body text-center">
                     ...
                     <h4 class="text-uppercase mb-5">Sky Bank Himayat Nagar Loaction</h4>
                    <address>#201 & 202, Ashoka Scintilla,
                        above Mebaz and opp. Malabar Gold & Diamonds,
                        Himayat Nagar,
                        Hyderabad, Telangana 500 029 </address>
                   </div>
                 </div>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                <div class="card border-0">
                   <div class="card-body text-center">
                     <i class="fa fa-map-marker fa-5x mb-3" aria-hidden="true"></i>
                     <h4 class="text-uppercase mb-5">Sky Bank Hi-Tech City Loaction</h4>
                     <address> PN 13/1, 13 & 11, 1/A,1/D, SBR Gateway Hi Tech City, Sector 2, near Huda Techno Enclave, Madhapur, Hyderabad, Telangana 500081 </address>
                   </div>
                 </div>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                <div class="card border-0">
                   <div class="card-body text-center">
                     ...
                     <p> manager@skybank.ac.in<br>
                    amshul@skybank.ac.in</p>
                   </div>
                 </div>
              </div>
            </div>
