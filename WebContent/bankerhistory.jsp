...
String nacc=(String)(session.getAttribute("nacc"));
ResultSet rs=stmt.executeQuery("select * from mdata where bankerid="+tempid);%>
<h1>History</h1>
  <table class="table table-striped">
  <tbody>
    <tr>
    <th scope="row">Customer Account Number</th>
      <th scope="row">Customer Name</th>
      <th scope="row">LOAN TYPE</th>
      <th scope="row">REQUESTED DATE</th>
      <th scope="row">GRANTED/REJECTED DATE</th>
...
String loan_status=rs.getString(6);
String requesttime=rs.getString(3);
String confirmtime=rs.getString(4);
ResultSet rs1=stmt1.executeQuery("select * from login where pid="+pid);
String nname="";
String accno="";
if(rs1.next()!=false){
	 nname=rs1.getString(2);
	 accno=rs1.getString(8);
}
%>
    <tr>
    <td><%=accno %></td>
...
System.out.println(e+"uid fetched in nbankerhistory");
}
%>
  </tbody>
</table>
