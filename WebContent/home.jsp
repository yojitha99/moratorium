...
System.out.println("Driver loaded home");
}
...
System.out.println("Connection established home");
}
...
<div id="footer" style="background-color: darkgrey;">
 ...
 <%
    ...
    System.out.println("Before result set in index page"+uid);
      ...
      if(loan2.equals("yes")){
      //botreply('<b>personal loan<b>');
      reply+="<input type='checkbox' id='loan2check'>Educational Loan<br>";
      }
      if(loan3.equals("yes")){
      //botreply('<b>personal loan<b>');
      ...
      %>
      var temp=<%=reply%>;
      //alert("calling botreply");
      botreply(temp);
     
      <%System.out.println("Calling checked");%>
      setTimeout(function(){alert("waiting");checkedLoans();},20000);
...
<%if(loan1.equals("yes")){%>alert("In first if of checked loans");<%System.out.println("It is yes");%>
if($("#loan1check").prop("checked")){
//alert("in loan1check of prop")
...
//alert("period1"+document.getElementById("period1check").value);
...
botreply("You have availed personal moratorium");
});
}
<%}else{System.out.println("in else of checked loans");%>
//botreply("in else pf loan2");
<%}%>
setTimeout(function(){alert("waiting for loan2house");loan2house(soj,yoj);},20000);
...
<%if(loan2.equals("yes")){%>alert("In first if of checked loans");<%System.out.println("It is yes");%>
if(yoj==1){
//alert("in loan2check of prop")
botreply("Select the period of time you want to avail moratorium for educational loan<br>"+
...
//alert("period2"+document.getElementById("period2check").value);
...
botreply("You have availed educational loan moratorium");
});
}
<%}else{System.out.println("in else of checked loans");%>
botreply("in else pf loan2");
<%}%>
setTimeout(function(){alert("waiting for loan3house");loan3house(soj);},20000);

}
function loan3house(soj)
{
//loan3
//alert("Entered loan3house"+soj);
<%if(loan3.equals("yes")){%>alert("In first if of checked 3 loans");<%System.out.println("It is yes");%>
if(soj==1){
//alert("in loan3check of prop")
...
//alert("period3"+document.getElementById("period3check").value);
...
botreply("You have availed housing moratorium");
});
}
<%}else{%>
botreply("in else pf loan3");
<%}%>
setTimeout(function(){alert("waiting for next question");firstquestion();},20000);
}
...
//  alert(ur+"is the message in first send");
...
{
botreply("Select the amount of income you receive pre lockdown:<br>"+
"<select  id='secondqn'>"+
...
{
botreply("Thank you!Your response has been recorded.Have a great day");
