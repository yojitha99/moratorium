            ...
            <div class="col md-4 col sm-4 col-xs-12">
                <form class="form-container" method="post" action="loginhandler.jsp">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Userid" name="name">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" class="btn btn-primary btn-block" value="LOGIN"><br>
                     <a href="login.jsp"><button id="mybutton" type="button" class="btn btn-primary btn-block">
